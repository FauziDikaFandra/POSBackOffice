...
Module Module1
    ...
    m_UserName3, m_Password3, m_Path, m_PathMOP, m_PathSales, usrID, PrintTyp, UserName,
    Pass, Trans_No_v, V_Code, Group_ID, FloorHistory, IPReader, transmitPower As String
...
1:
    ...
    Public Sub ConnectServer()
        ...
        IPReader = ReadIni("Device", "IPReader")
        transmitPower = ReadIni("Device", "transmitPower")
    End Sub
