...
Public Class ShortOverCashier
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSBackOffice.ShortOverCashier.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShortOverCashier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShortOverCashier = New ShortOverCashier()
        rpt.Site = Me.Site
        Return rpt
    End Function
