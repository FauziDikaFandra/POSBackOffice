...
Public Class VoucherSellingRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSBackOffice.VoucherSellingRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVoucherSellingRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VoucherSellingRpt = New VoucherSellingRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
