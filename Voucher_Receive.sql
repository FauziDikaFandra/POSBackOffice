...
/****** Object:  View [dbo].[v_Voucher_Receive]    Script Date: 09/23/2015 16:40:01 ******/
SET ANSI_NULLS ON
GO
...
SELECT     TOP (100) PERCENT a.v_no AS VNUMBER, a.v_amt AS AMOUNT, CASE WHEN b.V_TYPE = 'C' THEN 'CASH' ELSE '' END AS TYPE, b.V_SELL AS SELLINGDATE, 
                      LEFT(a.trans_no, 4) AS Store, SUBSTRING(a.trans_no, 9, 8) AS Tgl
FROM         dbo.vc_pay AS a INNER JOIN
                      dbo.NewVoc AS b ON a.v_no = b.V_NO
ORDER BY VNUMBER
