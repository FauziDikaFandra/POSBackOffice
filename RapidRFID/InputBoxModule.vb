Module InputBoxModule
    ...
    Public Function MyInputBox(ByVal Description As String, ByVal Title As String, ByVal DefaultValue As String, ByVal AlertIfEmpty As Boolean) As String
        ...
        inpForm.Width = 220
        inpForm.Height = 150
        'inpForm.ActiveControl = inptxtboxz
    ...
    Public Function MyInputBox2(ByVal Description As String, ByVal Title As String, ByVal DefaultValue As String, ByVal AlertIfEmpty As Boolean) As String
        stAlertIfEmpty = AlertIfEmpty
        InputForm.Text = Title
        InputForm.Label2.Text = Description
        'AddHandler cmdOKBtn.Click, AddressOf cmdOK2_Click
        'AddHandler InputForm.FormClosing, AddressOf inpForm_closing
